...
for k in range(0, epochs):
	...
	mistake_counter.append(mistake_count_train)
	mistake_count_train=0	
		

	print 'No of updates in each epoch', mistake_counter

for i in mistake_counter:
		total_mistakes+=i	
...
print 'Total number of examples on training set is :',training_size	*epochs
print 'The number of mistakes/updates made is :', total_mistakes
"""accuracy= (training_size*epochs -total_mistakes) / float(training_size *epochs)
...
print 'Margin Perceptron - Batch setting'
print '--------------------------------------------'
print 'Bias:', b
...
"""accuracy= (training_size * epoch -mp_total_mistakes) / float(training_size * epoch)
